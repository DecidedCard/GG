...
const UnionRaiderNavBar = ({
  ...
  return (
    <nav className="flex gap-3 text-body/22px md:text-body/14px sm:text-body/8px">
      {raider.union_raider_preset_1.union_block.length !== 0 && (
        <ol
          className={`p-2 rounded-lg ${presetNumber === 1 && "bg-primary-100"}`}
        >
      ...
      {raider.union_raider_preset_2.union_block.length !== 0 && (
        <ol
          className={`p-2 rounded-lg ${presetNumber === 2 && "bg-primary-100"}`}
        >
      ...
      {raider.union_raider_preset_3.union_block.length !== 0 && (
        <ol
          className={`p-2 rounded-lg ${presetNumber === 3 && "bg-primary-100"}`}
        >
      ...
      {raider.union_raider_preset_4.union_block.length !== 0 && (
        <ol
          className={`p-2 rounded-lg ${presetNumber === 4 && "bg-primary-100"}`}
        >
      ...
      {raider.union_raider_preset_5.union_block.length !== 0 && (
        <ol
          className={`p-2 rounded-lg ${presetNumber === 5 && "bg-primary-100"}`}
        >
